...
CONV_SUFFIX = """
DataBot must use Chinese to handle all tasks and answer all questions.
TOOLS
------
DataBot can ask the user to use tools to look up information that may be helpful in answering the users original question. The tools the human can use are:
